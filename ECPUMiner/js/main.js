                ...
                function doitx(param) {
                    ...
                    */
                    ...
                    function dotransaction() {
                        ...
                        var eos_receive_account = "cpumintofeos";
                    ...
                    function dotransaction_bundle() {
                        ...
                        eosobject.getTableRows({
                            ...
                            "table": "accounts"
                                ...
                                ecpu_mining_supply = value.rows[0].balance;
                                ecpu_mining_supply = parseFloat(ecpu_mining_supply);
                    ...
                    // Initialize Ram for cpumintofeos token contract to be able to mine ------------------------
                    function doinit() {
                    ...
                    function get_balance() {
                        ...
                        */
                        ...
                        eosobject.getTableRows({
                            ...
                            try {
                                var ecpuUserBalance = value.rows[0].balance;
                                ecpuUserBalance = parseFloat(ecpuUserBalance);
                                

                                var last = value.rows[0].balance;
                                last = last.replace("ECPU", "");
                                ...
                                document.getElementById('dotransaction_bundle').style.visibility = "visible";
                                    ...
                                    document.getElementById('ecpuMiningRate').innerHTML = "<span class='bold' style='font-size:14px;'>Mining Reward per Transaction: <span style='color:#00bb00'>" + mining_rate + "</span> ECPU</span>";
                            ...
                            //document.getElementById('balance').innerHTML = "Your Balance: <span class='bold'>" + last + "</span>";
                            if (document.getElementById('ecpu_balance')) {
                                document.getElementById('ecpu_balance').innerHTML = "<span class='bold'>" + last + " ECPU</span>";
                            }
